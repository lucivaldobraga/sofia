...
$consulta_total = selecionar("tabela_retirada","data, numeroferramenta, cracha","WHERE aeronave = '$aeronave'","ORDER BY cracha ASC, numeroferramenta ASC, DATE(data) ASC");
$consulta = selecionar("tabela_retirada","data, numeroferramenta, cracha","WHERE aeronave = '$aeronave'","ORDER BY cracha ASC, numeroferramenta ASC, DATE(data) ASC","LIMIT $offset OFFSET $x");
...
<html lang="pt-BR">
	<head>
        ...
        <script src="Js/retiradas_aeronave.js"></script>
		<title>Retiradas por Aeronave</title>
	</head>
	...
	<?php include ("nav.php"); ?>    
    	...
    	<article class="span8 offset4">
        	...
        	<section class="pagination">
				...
				if ($y*$offset == $x){
				?>
                <li class="active"><a href="retiradas_aeronave.php?x=<?php echo ($y)*$offset ?>"> <?php echo $y+1 ?></a></li>
                <?php }else{ ?>
			    <li><a href="retiradas_aeronave.php?x=<?php echo ($y)*$offset ?>&aeronave=<?php echo $aeronave ?>"> <?php echo $y+1 ?></a></li>		
               	<?php }} ?>
                </ul>
            </section>
			...
			<section> 
				<p>Nenhuma ferramenta em uso nesta aeronave!</p>
			</section>
            	<?php }?>
