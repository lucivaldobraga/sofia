...
window.onload = function() {
	var campo = document.getElementById("nomeguerra");
	...
	campo.onkeyup = function mostrarDica() {		
		...
		if (texto.length==0){
			...
			ajax.open("GET", "../Operacoes/retirar_ferramentas_autocompletar.php?letra="+texto, true);
			ajax.send();
		} 
	}
	...
	enviar.onclick = function (){
		...
		if (cracha.length==0){
			...
			ajax.open("GET", "../Operacoes/retirar_ferramentas_verificar_cracha.php?cracha="+cracha, true);
			ajax.send();
		}
	}
